create or replace package body etl_helper_result as
    ...
    begin
        ...
        dbms_stats.gather_table_stats(ownname => '${dataOwner}', tabname => 'RESULT_SWAP_' || suffix, method_opt => 'FOR ALL INDEXED COLUMNS');
