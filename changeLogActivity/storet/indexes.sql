...
create bitmap index rdql_storet_activity on r_detect_qnt_lmt_swap_storet(activity) parallel 4 nologging;
...
create bitmap index rdql_storet_analytical on r_detect_qnt_lmt_swap_storet(analytical_method) parallel 4 nologging;
...
create bitmap index rdql_storet_assemblage on r_detect_qnt_lmt_swap_storet(assemblage_sampled_name) parallel 4 nologging;
...
create bitmap index rdql_storet_char_name on r_detect_qnt_lmt_swap_storet(characteristic_name) parallel 4 nologging;
...
create bitmap index rdql_storet_char_type on r_detect_qnt_lmt_swap_storet(characteristic_type) parallel 4 nologging;
...
create bitmap index rdql_storet_country on r_detect_qnt_lmt_swap_storet(country_code) parallel 4 nologging;
...
create bitmap index rdql_storet_county on r_detect_qnt_lmt_swap_storet(county_code) parallel 4 nologging;
...
create bitmap index rdql_storet_event_date on r_detect_qnt_lmt_swap_storet(event_date) parallel 4 nologging;
...
create bitmap index rdql_storet_huc2 on r_detect_qnt_lmt_swap_storet(huc_2) parallel 4 nologging;
...
create bitmap index rdql_storet_huc4 on r_detect_qnt_lmt_swap_storet(huc_4) parallel 4 nologging;
...
create bitmap index rdql_storet_huc6 on r_detect_qnt_lmt_swap_storet(huc_6) parallel 4 nologging;
...
create bitmap index rdql_storet_huc8 on r_detect_qnt_lmt_swap_storet(huc_8) parallel 4 nologging;
...
create bitmap index rdql_storet_huc10 on r_detect_qnt_lmt_swap_storet(huc_10) parallel 4 nologging;
...
create bitmap index rdql_storet_huc12 on r_detect_qnt_lmt_swap_storet(HUC_12) parallel 4 nologging;
...
create bitmap index rdql_storet_organization on r_detect_qnt_lmt_swap_storet(organization) parallel 4 nologging;
...
create bitmap index rdql_storet_p_code on r_detect_qnt_lmt_swap_storet(p_code) parallel 4 nologging;
...
create bitmap index rdql_storet_project on r_detect_qnt_lmt_swap_storet(project_id) parallel 4 nologging;
...
create bitmap index rdql_storet_result on r_detect_qnt_lmt_swap_storet(result_id) parallel 4 nologging;
...
create bitmap index rdql_storet_sample_media on r_detect_qnt_lmt_swap_storet(sample_media) parallel 4 nologging;
...
create bitmap index rdql_storet_site on r_detect_qnt_lmt_swap_storet(site_id) parallel 4 nologging;
...
create bitmap index rdql_storet_site_type on r_detect_qnt_lmt_swap_storet(site_type) parallel 4 nologging;
...
create bitmap index rdql_storet_state on r_detect_qnt_lmt_swap_storet(state_code) parallel 4 nologging;
...
create bitmap index rdql_storet_station on r_detect_qnt_lmt_swap_storet(station_id) parallel 4 nologging;
...
create bitmap index rdql_storet_taxa_name on r_detect_qnt_lmt_swap_storet(sample_tissue_taxonomic_name) parallel 4 nologging;
