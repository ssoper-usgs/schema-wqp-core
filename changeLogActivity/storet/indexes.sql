...
--changeset drsteini:WQP-1033.create.rdql_storet_activity
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_ACTIVITY';
create bitmap index rdql_storet_activity on r_detect_qnt_lmt_swap_storet(activity) local parallel 4 nologging;
--rollback drop index rdql_storet_activity;

--changeset drsteini:WQP-1033.create.rdql_storet_analytical
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_ANALYTICAL';
create bitmap index rdql_storet_analytical on r_detect_qnt_lmt_swap_storet(analytical_method) local parallel 4 nologging;
--rollback drop index rdql_storet_analytical;

--changeset drsteini:WQP-1033.create.rdql_storet_assemblage
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_ASSEMBLAGE';
create bitmap index rdql_storet_assemblage on r_detect_qnt_lmt_swap_storet(assemblage_sampled_name) local parallel 4 nologging;
--rollback drop index rdql_storet_assemblage;

--changeset drsteini:WQP-1033.create.rdql_storet_char_name
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_CHAR_NAME';
create bitmap index rdql_storet_char_name on r_detect_qnt_lmt_swap_storet(characteristic_name) local parallel 4 nologging;
--rollback drop index rdql_storet_char_name;

--changeset drsteini:WQP-1033.create.rdql_storet_char_type
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_CHAR_TYPE';
create bitmap index rdql_storet_char_type on r_detect_qnt_lmt_swap_storet(characteristic_type) local parallel 4 nologging;
--rollback drop index rdql_storet_char_type;

--changeset drsteini:WQP-1033.create.rdql_storet_country
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_COUNTRY';
create bitmap index rdql_storet_country on r_detect_qnt_lmt_swap_storet(country_code) local parallel 4 nologging;
--rollback drop index rdql_storet_country;

--changeset drsteini:WQP-1033.create.rdql_storet_county
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_COUNTY';
create bitmap index rdql_storet_county on r_detect_qnt_lmt_swap_storet(county_code) local parallel 4 nologging;
--rollback drop index rdql_storet_county;

--changeset drsteini:WQP-1033.create.rdql_storet_event_date
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_EVENT_DATE';
create bitmap index rdql_storet_event_date on r_detect_qnt_lmt_swap_storet(event_date) local parallel 4 nologging;
--rollback drop index rdql_storet_event_date;

--changeset drsteini:WQP-1033.create.rdql_storet_huc2
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_HUC2';
create bitmap index rdql_storet_huc2 on r_detect_qnt_lmt_swap_storet(huc_2) local parallel 4 nologging;
--rollback drop index rdql_storet_huc2;

--changeset drsteini:WQP-1033.create.rdql_storet_huc4
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_HUC4';
create bitmap index rdql_storet_huc4 on r_detect_qnt_lmt_swap_storet(huc_4) local parallel 4 nologging;
--rollback drop index rdql_storet_huc4;

--changeset drsteini:WQP-1033.create.rdql_storet_huc6
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_HUC6';
create bitmap index rdql_storet_huc6 on r_detect_qnt_lmt_swap_storet(huc_6) local parallel 4 nologging;
--rollback drop index rdql_storet_huc6;

--changeset drsteini:WQP-1033.create.rdql_storet_huc8
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_HUC8';
create bitmap index rdql_storet_huc8 on r_detect_qnt_lmt_swap_storet(huc_8) local parallel 4 nologging;
--rollback drop index rdql_storet_huc8;

--changeset drsteini:WQP-1033.create.rdql_storet_huc10
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_HUC10';
create bitmap index rdql_storet_huc10 on r_detect_qnt_lmt_swap_storet(huc_10) local parallel 4 nologging;
--rollback drop index rdql_storet_huc10;

--changeset drsteini:WQP-1033.create.rdql_storet_huc12
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_HUC12';
create bitmap index rdql_storet_huc12 on r_detect_qnt_lmt_swap_storet(HUC_12) local parallel 4 nologging;
--rollback drop index rdql_storet_huc12;

--changeset drsteini:WQP-1033.create.rdql_storet_organization
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_ORGANIZATION';
create bitmap index rdql_storet_organization on r_detect_qnt_lmt_swap_storet(organization) local parallel 4 nologging;
--rollback drop index rdql_storet_organization;

--changeset drsteini:WQP-1033.create.rdql_storet_p_code
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_P_CODE';
create bitmap index rdql_storet_p_code on r_detect_qnt_lmt_swap_storet(p_code) local parallel 4 nologging;
--rollback drop index rdql_storet_p_code;

--changeset drsteini:WQP-1033.create.rdql_storet_project
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_PROJECT';
create bitmap index rdql_storet_project on r_detect_qnt_lmt_swap_storet(project_id) local parallel 4 nologging;
--rollback drop index rdql_storet_project;

--changeset drsteini:WQP-1033.create.rdql_storet_result
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_RESULT';
create bitmap index rdql_storet_result on r_detect_qnt_lmt_swap_storet(result_id) local parallel 4 nologging;
--rollback drop index rdql_storet_result;

--changeset drsteini:WQP-1033.create.rdql_storet_sample_media
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_SAMPLE_MEDIA';
create bitmap index rdql_storet_sample_media on r_detect_qnt_lmt_swap_storet(sample_media) local parallel 4 nologging;
--rollback drop index rdql_storet_sample_media;

--changeset drsteini:WQP-1033.create.rdql_storet_site
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_SITE';
create bitmap index rdql_storet_site on r_detect_qnt_lmt_swap_storet(site_id) local parallel 4 nologging;
--rollback drop index rdql_storet_site;

--changeset drsteini:WQP-1033.create.rdql_storet_site_type
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_SITE_TYPE';
create bitmap index rdql_storet_site_type on r_detect_qnt_lmt_swap_storet(site_type) local parallel 4 nologging;
--rollback drop index rdql_storet_site_type;

--changeset drsteini:WQP-1033.create.rdql_storet_state
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_STATE';
create bitmap index rdql_storet_state on r_detect_qnt_lmt_swap_storet(state_code) local parallel 4 nologging;
--rollback drop index rdql_storet_state;

--changeset drsteini:WQP-1033.create.rdql_storet_station
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_STATION';
create bitmap index rdql_storet_station on r_detect_qnt_lmt_swap_storet(station_id) local parallel 4 nologging;
--rollback drop index rdql_storet_station;

--changeset drsteini:WQP-1033.create.rdql_storet_taxa_name
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_STORET_TAXA_NAME';
create bitmap index rdql_storet_taxa_name on r_detect_qnt_lmt_swap_storet(sample_tissue_taxonomic_name) local parallel 4 nologging;
