...
create bitmap index rdql_storet_activity on res_detect_qnt_lmt_swap_storet(activity) local parallel 4 nologging;
...
create bitmap index rdql_storet_analytical on res_detect_qnt_lmt_swap_storet(analytical_method) local parallel 4 nologging;
...
create bitmap index rdql_storet_assemblage on res_detect_qnt_lmt_swap_storet(assemblage_sampled_name) local parallel 4 nologging;
...
create bitmap index rdql_storet_char_name on res_detect_qnt_lmt_swap_storet(characteristic_name) local parallel 4 nologging;
...
create bitmap index rdql_storet_char_type on res_detect_qnt_lmt_swap_storet(characteristic_type) local parallel 4 nologging;
...
create bitmap index rdql_storet_country on res_detect_qnt_lmt_swap_storet(country_code) local parallel 4 nologging;
...
create bitmap index rdql_storet_county on res_detect_qnt_lmt_swap_storet(county_code) local parallel 4 nologging;
...
create bitmap index rdql_storet_event_date on res_detect_qnt_lmt_swap_storet(event_date) local parallel 4 nologging;
...
create bitmap index rdql_storet_huc2 on res_detect_qnt_lmt_swap_storet(huc_2) local parallel 4 nologging;
...
create bitmap index rdql_storet_huc4 on res_detect_qnt_lmt_swap_storet(huc_4) local parallel 4 nologging;
...
create bitmap index rdql_storet_huc6 on res_detect_qnt_lmt_swap_storet(huc_6) local parallel 4 nologging;
...
create bitmap index rdql_storet_huc8 on res_detect_qnt_lmt_swap_storet(huc_8) local parallel 4 nologging;
...
create bitmap index rdql_storet_huc10 on res_detect_qnt_lmt_swap_storet(huc_10) local parallel 4 nologging;
...
create bitmap index rdql_storet_huc12 on res_detect_qnt_lmt_swap_storet(HUC_12) local parallel 4 nologging;
...
create bitmap index rdql_storet_organization on res_detect_qnt_lmt_swap_storet(organization) local parallel 4 nologging;
...
create bitmap index rdql_storet_p_code on res_detect_qnt_lmt_swap_storet(p_code) local parallel 4 nologging;
...
create bitmap index rdql_storet_project on res_detect_qnt_lmt_swap_storet(project_id) local parallel 4 nologging;
...
create bitmap index rdql_storet_result on res_detect_qnt_lmt_swap_storet(result_id) local parallel 4 nologging;
...
create bitmap index rdql_storet_sample_media on res_detect_qnt_lmt_swap_storet(sample_media) local parallel 4 nologging;
...
create bitmap index rdql_storet_site on res_detect_qnt_lmt_swap_storet(site_id) local parallel 4 nologging;
...
create bitmap index rdql_storet_site_type on res_detect_qnt_lmt_swap_storet(site_type) local parallel 4 nologging;
...
create bitmap index rdql_storet_state on res_detect_qnt_lmt_swap_storet(state_code) local parallel 4 nologging;
...
create bitmap index rdql_storet_station on res_detect_qnt_lmt_swap_storet(station_id) local parallel 4 nologging;
