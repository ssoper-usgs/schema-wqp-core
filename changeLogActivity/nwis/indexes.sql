...
create bitmap index rdql_nwis_activity on r_detect_qnt_lmt_swap_nwis(activity) parallel 4 nologging;
...
create bitmap index rdql_nwis_analytical on r_detect_qnt_lmt_swap_nwis(analytical_method) parallel 4 nologging;
...
create bitmap index rdql_nwis_assemblage on r_detect_qnt_lmt_swap_nwis(assemblage_sampled_name) parallel 4 nologging;
...
create bitmap index rdql_nwis_char_name on r_detect_qnt_lmt_swap_nwis(characteristic_name) parallel 4 nologging;
...
create bitmap index rdql_nwis_char_type on r_detect_qnt_lmt_swap_nwis(characteristic_type) parallel 4 nologging;
...
create bitmap index rdql_nwis_country on r_detect_qnt_lmt_swap_nwis(country_code) parallel 4 nologging;
...
create bitmap index rdql_nwis_county on r_detect_qnt_lmt_swap_nwis(county_code) parallel 4 nologging;
...
create bitmap index rdql_nwis_event_date on r_detect_qnt_lmt_swap_nwis(event_date) parallel 4 nologging;
...
create bitmap index rdql_nwis_huc2 on r_detect_qnt_lmt_swap_nwis(huc_2) parallel 4 nologging;
...
create bitmap index rdql_nwis_huc4 on r_detect_qnt_lmt_swap_nwis(huc_4) parallel 4 nologging;
...
create bitmap index rdql_nwis_huc6 on r_detect_qnt_lmt_swap_nwis(huc_6) parallel 4 nologging;
...
create bitmap index rdql_nwis_huc8 on r_detect_qnt_lmt_swap_nwis(huc_8) parallel 4 nologging;
...
create bitmap index rdql_nwis_huc10 on r_detect_qnt_lmt_swap_nwis(huc_10) parallel 4 nologging;
...
create bitmap index rdql_nwis_huc12 on r_detect_qnt_lmt_swap_nwis(HUC_12) parallel 4 nologging;
...
create bitmap index rdql_nwis_organization on r_detect_qnt_lmt_swap_nwis(organization) parallel 4 nologging;
...
create bitmap index rdql_nwis_p_code on r_detect_qnt_lmt_swap_nwis(p_code) parallel 4 nologging;
...
create bitmap index rdql_nwis_project on r_detect_qnt_lmt_swap_nwis(project_id) parallel 4 nologging;
...
create bitmap index rdql_nwis_result on r_detect_qnt_lmt_swap_nwis(result_id) parallel 4 nologging;
...
create bitmap index rdql_nwis_sample_media on r_detect_qnt_lmt_swap_nwis(sample_media) parallel 4 nologging;
...
create bitmap index rdql_nwis_site on r_detect_qnt_lmt_swap_nwis(site_id) parallel 4 nologging;
...
create bitmap index rdql_nwis_site_type on r_detect_qnt_lmt_swap_nwis(site_type) parallel 4 nologging;
...
create bitmap index rdql_nwis_state on r_detect_qnt_lmt_swap_nwis(state_code) parallel 4 nologging;
...
create bitmap index rdql_nwis_station on r_detect_qnt_lmt_swap_nwis(station_id) parallel 4 nologging;
...
create bitmap index rdql_nwis_taxa_name on r_detect_qnt_lmt_swap_nwis(sample_tissue_taxonomic_name) parallel 4 nologging;
