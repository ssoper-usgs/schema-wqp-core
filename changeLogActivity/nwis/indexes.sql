...
--changeset drsteini:WQP-1033.create.rdql_nwis_activity
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_ACTIVITY';
create bitmap index rdql_nwis_activity on r_detect_qnt_lmt_swap_nwis(activity) local parallel 4 nologging;
--rollback drop index rdql_nwis_activity;

--changeset drsteini:WQP-1033.create.rdql_nwis_analytical
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_ANALYTICAL';
create bitmap index rdql_nwis_analytical on r_detect_qnt_lmt_swap_nwis(analytical_method) local parallel 4 nologging;
--rollback drop index rdql_nwis_analytical;

--changeset drsteini:WQP-1033.create.rdql_nwis_assemblage
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_ASSEMBLAGE';
create bitmap index rdql_nwis_assemblage on r_detect_qnt_lmt_swap_nwis(assemblage_sampled_name) local parallel 4 nologging;
--rollback drop index rdql_nwis_assemblage;

--changeset drsteini:WQP-1033.create.rdql_nwis_char_name
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_CHAR_NAME';
create bitmap index rdql_nwis_char_name on r_detect_qnt_lmt_swap_nwis(characteristic_name) local parallel 4 nologging;
--rollback drop index rdql_nwis_char_name;

--changeset drsteini:WQP-1033.create.rdql_nwis_char_type
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_CHAR_TYPE';
create bitmap index rdql_nwis_char_type on r_detect_qnt_lmt_swap_nwis(characteristic_type) local parallel 4 nologging;
--rollback drop index rdql_nwis_char_type;

--changeset drsteini:WQP-1033.create.rdql_nwis_country
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_COUNTRY';
create bitmap index rdql_nwis_country on r_detect_qnt_lmt_swap_nwis(country_code) local parallel 4 nologging;
--rollback drop index rdql_nwis_country;

--changeset drsteini:WQP-1033.create.rdql_nwis_county
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_COUNTY';
create bitmap index rdql_nwis_county on r_detect_qnt_lmt_swap_nwis(county_code) local parallel 4 nologging;
--rollback drop index rdql_nwis_county;

--changeset drsteini:WQP-1033.create.rdql_nwis_event_date
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_EVENT_DATE';
create bitmap index rdql_nwis_event_date on r_detect_qnt_lmt_swap_nwis(event_date) local parallel 4 nologging;
--rollback drop index rdql_nwis_event_date;

--changeset drsteini:WQP-1033.create.rdql_nwis_huc2
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_HUC2';
create bitmap index rdql_nwis_huc2 on r_detect_qnt_lmt_swap_nwis(huc_2) local parallel 4 nologging;
--rollback drop index rdql_nwis_huc2;

--changeset drsteini:WQP-1033.create.rdql_nwis_huc4
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_HUC4';
create bitmap index rdql_nwis_huc4 on r_detect_qnt_lmt_swap_nwis(huc_4) local parallel 4 nologging;
--rollback drop index rdql_nwis_huc4;

--changeset drsteini:WQP-1033.create.rdql_nwis_huc6
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_HUC6';
create bitmap index rdql_nwis_huc6 on r_detect_qnt_lmt_swap_nwis(huc_6) local parallel 4 nologging;
--rollback drop index rdql_nwis_huc6;

--changeset drsteini:WQP-1033.create.rdql_nwis_huc8
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_HUC8';
create bitmap index rdql_nwis_huc8 on r_detect_qnt_lmt_swap_nwis(huc_8) local parallel 4 nologging;
--rollback drop index rdql_nwis_huc8;

--changeset drsteini:WQP-1033.create.rdql_nwis_huc10
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_HUC10';
create bitmap index rdql_nwis_huc10 on r_detect_qnt_lmt_swap_nwis(huc_10) local parallel 4 nologging;
--rollback drop index rdql_nwis_huc10;

--changeset drsteini:WQP-1033.create.rdql_nwis_huc12
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_HUC12';
create bitmap index rdql_nwis_huc12 on r_detect_qnt_lmt_swap_nwis(HUC_12) local parallel 4 nologging;
--rollback drop index rdql_nwis_huc12;

--changeset drsteini:WQP-1033.create.rdql_nwis_organization
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_ORGANIZATION';
create bitmap index rdql_nwis_organization on r_detect_qnt_lmt_swap_nwis(organization) local parallel 4 nologging;
--rollback drop index rdql_nwis_organization;

--changeset drsteini:WQP-1033.create.rdql_nwis_p_code
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_P_CODE';
create bitmap index rdql_nwis_p_code on r_detect_qnt_lmt_swap_nwis(p_code) local parallel 4 nologging;
--rollback drop index rdql_nwis_p_code;

--changeset drsteini:WQP-1033.create.rdql_nwis_project
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_PROJECT';
create bitmap index rdql_nwis_project on r_detect_qnt_lmt_swap_nwis(project_id) local parallel 4 nologging;
--rollback drop index rdql_nwis_project;

--changeset drsteini:WQP-1033.create.rdql_nwis_result
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_RESULT';
create bitmap index rdql_nwis_result on r_detect_qnt_lmt_swap_nwis(result_id) local parallel 4 nologging;
--rollback drop index rdql_nwis_result;

--changeset drsteini:WQP-1033.create.rdql_nwis_sample_media
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_SAMPLE_MEDIA';
create bitmap index rdql_nwis_sample_media on r_detect_qnt_lmt_swap_nwis(sample_media) local parallel 4 nologging;
--rollback drop index rdql_nwis_sample_media;

--changeset drsteini:WQP-1033.create.rdql_nwis_site
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_SITE';
create bitmap index rdql_nwis_site on r_detect_qnt_lmt_swap_nwis(site_id) local parallel 4 nologging;
--rollback drop index rdql_nwis_site;

--changeset drsteini:WQP-1033.create.rdql_nwis_site_type
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_SITE_TYPE';
create bitmap index rdql_nwis_site_type on r_detect_qnt_lmt_swap_nwis(site_type) local parallel 4 nologging;
--rollback drop index rdql_nwis_site_type;

--changeset drsteini:WQP-1033.create.rdql_nwis_state
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_STATE';
create bitmap index rdql_nwis_state on r_detect_qnt_lmt_swap_nwis(state_code) local parallel 4 nologging;
--rollback drop index rdql_nwis_state;

--changeset drsteini:WQP-1033.create.rdql_nwis_station
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_STATION';
create bitmap index rdql_nwis_station on r_detect_qnt_lmt_swap_nwis(station_id) local parallel 4 nologging;
--rollback drop index rdql_nwis_station;

--changeset drsteini:WQP-1033.create.rdql_nwis_taxa_name
--preconditions onFail:MARK_RAN onError:HALT
--precondition-sql-check expectedResult:0 select count(*) from user_indexes where index_name = 'RDQL_NWIS_TAXA_NAME';
create bitmap index rdql_nwis_taxa_name on r_detect_qnt_lmt_swap_nwis(sample_tissue_taxonomic_name) local parallel 4 nologging;
