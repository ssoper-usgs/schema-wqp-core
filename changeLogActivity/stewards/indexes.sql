...
create bitmap index rdql_stewards_activity on r_detect_qnt_lmt_swap_stewards(activity) parallel 4 nologging;
...
create bitmap index rdql_stewards_analytical on r_detect_qnt_lmt_swap_stewards(analytical_method) parallel 4 nologging;
...
create bitmap index rdql_stewards_assemblage on r_detect_qnt_lmt_swap_stewards(assemblage_sampled_name) parallel 4 nologging;
...
create bitmap index rdql_stewards_char_name on r_detect_qnt_lmt_swap_stewards(characteristic_name) parallel 4 nologging;
...
create bitmap index rdql_stewards_char_type on r_detect_qnt_lmt_swap_stewards(characteristic_type) parallel 4 nologging;
...
create bitmap index rdql_stewards_country on r_detect_qnt_lmt_swap_stewards(country_code) parallel 4 nologging;
...
create bitmap index rdql_stewards_county on r_detect_qnt_lmt_swap_stewards(county_code) parallel 4 nologging;
...
create bitmap index rdql_stewards_event_date on r_detect_qnt_lmt_swap_stewards(event_date) parallel 4 nologging;
...
create bitmap index rdql_stewards_huc2 on r_detect_qnt_lmt_swap_stewards(huc_2) parallel 4 nologging;
...
create bitmap index rdql_stewards_huc4 on r_detect_qnt_lmt_swap_stewards(huc_4) parallel 4 nologging;
...
create bitmap index rdql_stewards_huc6 on r_detect_qnt_lmt_swap_stewards(huc_6) parallel 4 nologging;
...
create bitmap index rdql_stewards_huc8 on r_detect_qnt_lmt_swap_stewards(huc_8) parallel 4 nologging;
...
create bitmap index rdql_stewards_huc10 on r_detect_qnt_lmt_swap_stewards(huc_10) parallel 4 nologging;
...
create bitmap index rdql_stewards_huc12 on r_detect_qnt_lmt_swap_stewards(HUC_12) parallel 4 nologging;
...
create bitmap index rdql_stewards_organization on r_detect_qnt_lmt_swap_stewards(organization) parallel 4 nologging;
...
create bitmap index rdql_stewards_p_code on r_detect_qnt_lmt_swap_stewards(p_code) parallel 4 nologging;
...
create bitmap index rdql_stewards_project on r_detect_qnt_lmt_swap_stewards(project_id) parallel 4 nologging;
...
create bitmap index rdql_stewards_result on r_detect_qnt_lmt_swap_stewards(result_id) parallel 4 nologging;
...
create bitmap index rdql_stewards_sample_media on r_detect_qnt_lmt_swap_stewards(sample_media) parallel 4 nologging;
...
create bitmap index rdql_stewards_site on r_detect_qnt_lmt_swap_stewards(site_id) parallel 4 nologging;
...
create bitmap index rdql_stewards_site_type on r_detect_qnt_lmt_swap_stewards(site_type) parallel 4 nologging;
...
create bitmap index rdql_stewards_state on r_detect_qnt_lmt_swap_stewards(state_code) parallel 4 nologging;
...
create bitmap index rdql_stewards_station on r_detect_qnt_lmt_swap_stewards(station_id) parallel 4 nologging;
...
create bitmap index rdql_stewards_taxa_name on r_detect_qnt_lmt_swap_stewards(sample_tissue_taxonomic_name) parallel 4 nologging;
