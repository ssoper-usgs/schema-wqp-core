...
create bitmap index rdql_biodata_activity on r_detect_qnt_lmt_swap_biodata(activity) parallel 4 nologging;
...
create bitmap index rdql_biodata_analytical on r_detect_qnt_lmt_swap_biodata(analytical_method) parallel 4 nologging;
...
create bitmap index rdql_biodata_assemblage on r_detect_qnt_lmt_swap_biodata(assemblage_sampled_name) parallel 4 nologging;
...
create bitmap index rdql_biodata_char_name on r_detect_qnt_lmt_swap_biodata(characteristic_name) parallel 4 nologging;
...
create bitmap index rdql_biodata_char_type on r_detect_qnt_lmt_swap_biodata(characteristic_type) parallel 4 nologging;
...
create bitmap index rdql_biodata_country on r_detect_qnt_lmt_swap_biodata(country_code) parallel 4 nologging;
...
create bitmap index rdql_biodata_county on r_detect_qnt_lmt_swap_biodata(county_code) parallel 4 nologging;
...
create bitmap index rdql_biodata_event_date on r_detect_qnt_lmt_swap_biodata(event_date) parallel 4 nologging;
...
create bitmap index rdql_biodata_huc2 on r_detect_qnt_lmt_swap_biodata(huc_2) parallel 4 nologging;
...
create bitmap index rdql_biodata_huc4 on r_detect_qnt_lmt_swap_biodata(huc_4) parallel 4 nologging;
...
create bitmap index rdql_biodata_huc6 on r_detect_qnt_lmt_swap_biodata(huc_6) parallel 4 nologging;
...
create bitmap index rdql_biodata_huc8 on r_detect_qnt_lmt_swap_biodata(huc_8) parallel 4 nologging;
...
create bitmap index rdql_biodata_huc10 on r_detect_qnt_lmt_swap_biodata(huc_10) parallel 4 nologging;
...
create bitmap index rdql_biodata_huc12 on r_detect_qnt_lmt_swap_biodata(HUC_12) parallel 4 nologging;
...
create bitmap index rdql_biodata_organization on r_detect_qnt_lmt_swap_biodata(organization) parallel 4 nologging;
...
create bitmap index rdql_biodata_p_code on r_detect_qnt_lmt_swap_biodata(p_code) parallel 4 nologging;
...
create bitmap index rdql_biodata_project on r_detect_qnt_lmt_swap_biodata(project_id) parallel 4 nologging;
...
create bitmap index rdql_biodata_result on r_detect_qnt_lmt_swap_biodata(result_id) parallel 4 nologging;
...
create bitmap index rdql_biodata_sample_media on r_detect_qnt_lmt_swap_biodata(sample_media) parallel 4 nologging;
...
create bitmap index rdql_biodata_site on r_detect_qnt_lmt_swap_biodata(site_id) parallel 4 nologging;
...
create bitmap index rdql_biodata_site_type on r_detect_qnt_lmt_swap_biodata(site_type) parallel 4 nologging;
...
create bitmap index rdql_biodata_state on r_detect_qnt_lmt_swap_biodata(state_code) parallel 4 nologging;
...
create bitmap index rdql_biodata_station on r_detect_qnt_lmt_swap_biodata(station_id) parallel 4 nologging;
...
create bitmap index rdql_biodata_taxa_name on r_detect_qnt_lmt_swap_biodata(sample_tissue_taxonomic_name) parallel 4 nologging;
