...
--rollback alter table wqp_results drop constraint results_station_fk;
...
--rollback alter table wqp_results drop constraint results_data_source_fk;
...
--rollback alter table wqp_results drop constraint results_event_date_fk;
...
--rollback alter table wqp_results drop constraint results_analytical_method_fk;
...
--rollback alter table wqp_results drop constraint results_p_code_fk;
...
--rollback alter table wqp_results drop constraint results_characteristic_name_fk;
...
--rollback alter table wqp_results drop constraint results_characteristic_type_fk;
...
--rollback alter table wqp_results drop constraint results_sample_media_fk;
...
--rollback alter table wqp_results drop constraint results_organization_fk;
...
--rollback alter table wqp_results drop constraint results_site_type_fk;
...
--rollback alter table wqp_results drop constraint results_country_fk;
...
--rollback alter table wqp_results drop constraint results_state_fk;
...
--rollback alter table stations drop constraint stations_data_source_fk;
...
--rollback alter table stations drop constraint stations_organization_fk;
...
--rollback alter table stations drop constraint stations_site_type_fk;
...
--rollback alter table stations drop constraint stations_country_fk;
...
--rollback alter table stations drop constraint stations_state_fk;
...
--rollback alter table stations drop constraint stations_county_fk;
